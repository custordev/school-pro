...
export default function SiteFooter() {
  return (
    <footer className="w-full bg-violet-600 text-white">
        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          <div className="space-y-4">
            ...
            <div className="flex space-x-4">
              ...
              >
                <Twitter className="h-4 w-4 text-violet-500" />
              ...
              <Link
                ...
                className="rounded-full bg-white p-2 hover:bg-white/90"
              >
                <Youtube className="h-4 w-4 text-violet-500" />
          ...
          <div className="space-y-4">
            ...
            <form className="space-y-2">
              ...
              />
              <Button
                className="w-full bg-white text-violet-500 hover:bg-white/90"
                type="submit"
              >
                Subscribe
                <svg
      ...
      <div className="border-t border-white/10">
        <div className="container flex flex-col items-center justify-center gap-4 py-6 text-center text-sm md:h-16 md:flex-row md:py-0">
          <div className="text-white/60">
            Copyright@{new Date().getFullYear()} All Right Reserved School Pro.
          </div>
        </div>
      </div>
    </footer>
